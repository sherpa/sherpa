...
#
echo -Csetup-args=-Dbuild-xspec=true -Csetup-args=-Dbuild-xspec-version=$XSPECVER -Csetup-args=-Dbuild-xspec-location=$CONDA_PREFIX -Csetup-args=-Dbuild-xspec-libraries=XSFunctions,XSUtil,XS
