...
# Axis is imported in case any code tries to access it. This is a
# temporary fix, as users should directly import from
# sherpa.utils.axes instead.
#
from sherpa.utils.axes import Axis, PointAxis, IntegratedAxis
