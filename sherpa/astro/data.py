...
class DataIMGInt(IMGMixIn, Data2DInt):
    ...
    def from_2d_array(cls,
        ...
        x0_bounds, x1_bounds: ndarray, optional
            The independent variable arrays; the length of x0_bounds must
            be one more than then length of y's first dimension. The first image
            pixel is bounded by x0_bounds[0] and x0_bounds[1], the second pixel by
            x0_bounds[1] and x0_bounds[2], etc.
            The same applies to x1_bounds and y's second dimension.
            If not provided, they will be generated, starting at 0.5.
