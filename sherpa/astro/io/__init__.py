...
def _pack_arf(dataset: Union[DataARF, ARF1D]) -> BlockList:
    ...
    #
    acols = [Column("ENERG_LO", dataset.energ_lo.astype(numpy.float32)),
             Column("ENERG_HI", dataset.energ_hi.astype(numpy.float32)),
             Column("SPECRESP", dataset.specresp.astype(numpy.float32))]
