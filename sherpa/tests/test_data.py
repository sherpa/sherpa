...
def test_datasimulfit_to_guess_axis_difference():
    ...
    emsg = "Unable to create guess when number of " + \
        "independent axes varies"
...
@pytest.mark.parametrize("d1,d2,emsg",
                         [ # First dataset has no data
                           (Data1D("d1", None, [3, 4, 5]),
                            Data1D("d2", [10, 20, 30, 40], [3, 4, 5, 6]),
                            "The independent axis of 'd1' has not been set"),
                           (Data1D("d1", [1, 2, 3], None),
                            Data1D("d2", [10, 20, 30, 40], [3, 4, 5, 6]),
                            "The dependent axis of 'd1' has not been set"),
                           (Data1D("d1", None, None),
                            Data1D("d2", [10, 20, 30, 40], [3, 4, 5, 6]),
                            "The size of 'd1' has not been set"),
                           # Second dataset has no data
                           (Data1D("d1", [1, 2, 3], [3, 4, 5]),
                            Data1D("d2", None, [3, 4, 5, 6]),
                            "The independent axis of 'd2' has not been set"),
                           (Data1D("d1", [1, 2, 3], [3, 4, 5]),
                            Data1D("d2", [10, 20, 30, 40], None),
                            "The dependent axis of 'd2' has not been set"),
                           (Data1D("d1", [1, 2, 3], [3, 4, 5]),
                            Data1D("d2", None, None),
                            "The size of 'd2' has not been set"),
                         ])
def test_datasimulfit_to_guess_missing_axis(d1, d2, emsg):
    """Very basic check that this fails"""
