...
@pytest.mark.parametrize("stat,usestat,usesys,finalstat,rel", [
    (LeastSq, False, False, fit_lsq, 2e-6),
    (Chi2, True, True, fit_chi2_tt, 2e-6),
    (Chi2Gehrels, True, True, fit_chi2_tt, 2e-6),
    (Chi2Gehrels, False, False, fit_gehrels_ff, 2e-6),
    (Chi2XspecVar, False, True, fit_xvar_ft, 2e-6),
    (Chi2ConstVar, False, True, fit_cvar_ft, 2e-6),
    (Chi2ModVar, True, True, fit_mvar_xt, 2e-6),
    (Chi2ModVar, True, False, fit_mvar_xf, 2e-6),
    (Chi2ModVar, False, False, fit_mvar_xf, 2e-6),
    (Chi2ModVar, False, True, fit_mvar_xt, 2e-6),

    (Cash, True, True, fit_cash, 2e-6),
    (CStat, True, True, fit_cstat, 2e-4),
])
