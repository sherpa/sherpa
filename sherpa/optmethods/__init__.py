...
from sherpa.optmethods.optfcts import ArrayType, OptReturn, \
    grid_search, lmdif, montecarlo, neldermead
...
class OptMethod(NoNewAttributesAfterInit):
    ...
    # TODO: can this be rempoved as CIAO 4.2 was a long time ago.
    #
    ...
    def fit(self,
            statfunc: Callable[..., tuple[float, np.ndarray]],
            pars: ArrayType,
            parmins: ArrayType,
            parmaxes: ArrayType,
