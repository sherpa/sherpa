   ...
   a. ``sherpa/astro/xspec/src/_xspec.cc``
      ...
      **not** the XSPEC model name (the first argument of the model
      ...
      models.
       ...
       .. note:: Prior to Sherpa 4.17.1 the additive models needed to
		 be sent an extra value to represent the normalization,
		 and used a macro name that ended in ``_NORM``.
